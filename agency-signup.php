...
if(isset($_POST['submit']))		
    ...
    require_once("_con.php");
            ...
            $Insert = "insert into credentials(name,email,password,is_agency_member) values(?, ?, ?, ?)";
            ...
            if ($rnum == 0) {
                ...
                $stmt->bind_param("ssss", $name, $email, $password, $is_agency_member);
                if ($stmt->execute()) {
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-8 text-center mx-auto">
              <h1 class="text-white mb-1 mt-5">Welcome Agency Members!</h1>
              ...
              <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class=" text-sm mx-auto">
                   Signup as a customer.
                    <a href="sign-up.php" class="text-dark font-weight-bolder">Sign up</a>
                  </p>
                  </div>
                </div>
            </div>
