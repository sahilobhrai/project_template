...
if(!defined("ASLAN")){define("ASLAN",true);}
...
$stmt = $con->prepare("SELECT * FROM credentials WHERE email = ? AND password = ?");
...
if ($result->num_rows == 1) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $_SESSION['is_member'] = $row['is_agency_member'];
    }
    $_SESSION['login_email'] = $email;
    header('Location:dashboard/index.php'); // Redirect to dashboard page
} else {
